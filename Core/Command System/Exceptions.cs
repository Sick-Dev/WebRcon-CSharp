...
namespace WebRcon {
    public class InvalidCommandTypeConstructorException : WebRconException {
        Type type;
    ...
    public class UnsupportedCommandDeclarationException : WebRconException {
        MethodInfo method;
    ...
    public class NoSuitableCommandFoundException : WebRconException {
        MethodInfo method;
    ...
    public class InvalidArgumentFormatException<T> : WebRconException {
        string argument;
    ...
    public class NoValidParserFoundException : WebRconException {
        Type type;
    ...
    public class AmbiguousCommandCallException : WebRconException {
        string rawCall;
        CommandBase[] matches;
    ...
    public class CommandOverloadNotFoundException : WebRconException {
    ...
    public class DuplicatedParserException : WebRconException {
